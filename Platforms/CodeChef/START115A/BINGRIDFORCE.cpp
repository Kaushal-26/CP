...
void solve() {
        ...
        ROF(i, 1, n - 1) {
                ...
                int cnt = accumulate(a[i].begin(), a[i].end(), 0LL);
                if(T > 1 && f && cnt > 1) {
                        FOR(j, m) if(a[i + 1][j]) a[i][j] = 1;
                }
        }
...
// Hi Codechef_admin I have seen this announcement(https://discuss.codechef.com/t/important-update/105637) 

// But currently are there any future plans for Cook-Off, Lunchtime, or Snackdown?
